...
from Const import COLOR_LIME, WIN_WIDTH, MENU_OPTION, COLOR_WHITE
    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                self.menu_text(text_size=30, text=MENU_OPTION[i], text_color= COLOR_WHITE, text_center_pos=((WIN_WIDTH / 2), 160 + 30 * i))
