...
from Const import COLOR_YELLOW, COLOR_WHITE, SCORE_POS, MENU_OPTION
...
class Score:
    def __init__(self, window: Surface):
        self.window = window
        self.surf = pygame.image.load('asset/SaldoScore.png').convert_alpha()
        self.rect = self.surf.get_rect(left=0, top=0)
        pass

    def save(self, game_mode: str, player_score: list[int]):
        pygame.mixer_music.load('asset/SaldoScore.mp3')
